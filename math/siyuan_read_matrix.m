...
for curr_ses = 1:2
    ...
    for i_sub = sub_list
        ...
        count = 0;
        for j_run  = 1 : num_run
            file_name = sprintf([path, 'sub-%03d/ses2/sub-%03d_bis_matrix_%d_matrix.txt'], i_sub, i_sub, j_run);
    ...
    save(['/home/kailong/Scheinost-Lab/math/data/TwoSession/all_mats_ses' num2str(curr_ses) '.mat'], 'all_mats')
    save(['/home/kailong/Scheinost-Lab/math/data/TwoSession/incomp_id_ses' num2str(curr_ses) '.mat'], 'incomp_id')
end